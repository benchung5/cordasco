...
<html lang="en-US">
   <head>
      <title>Cordasco Chiropractic & Massage</title>
      <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/> <!--320-->
      <meta name="description" content="Chiropractic, Massage, Foot Orthotics" />
      <meta charset="UTF-8" />
                            ...
                            <nav>
                                ...
                                <ul class="menu group">
                                    ...
                                    <li class="<?php if ($_SERVER['REQUEST_URI'] == "/piecms-theme/treatments-available.php") { echo "active"; } ?>">
                                        <a href="treatments-available.php">Treatments</a>
                                    </li>
